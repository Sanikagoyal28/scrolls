    ...
    return <>
        ...
        <div className="Domain">
            ...
            <ul>
                ...
                <li>
                    <p className="domainHeading">A neural network</p>
                    <p className="domainText">A neural network is a method in artificial intelligence that teaches computers to process data in a way that is inspired by the human brain. Neural networks can help computers make intelligent decisions with limited human assistance. This is because they can learn and model the relationships between input and output data that are nonlinear and complex. Thus neural networks can comprehend unstructured data and make general observations without explicit training. How has the incorporation of this technology in the current working sector affected the conventional scenarios?</p>
                </li>
                <li>
                    <p className="domainHeading">Cybersecurity</p>
                ...
                <li>
                    <p className="domainHeading">Cryptocurrency (Blockchain)</p>
                    <p className="domainText">A cryptocurrency is a digital currency, which is an alternative form of payment created using encryption algorithms. The use of encryption technologies means that cryptocurrencies function both as a currency and as a virtual accounting system. Bitcoin, Ethereum, and other crypto are revolutionizing how we invest, bank, and use money. Compare and contrast digital transactions and transactions through cryptocurrency. Share your insights on investments using cryptocurrency. What sheer according to you can cryptocurrency bring to the global economic system?</p>
                </li>
                <li>
                    <p className="domainHeading">Wireless Sensor Network (WSN)</p>
